...
namespace Scheduling_Criteria
{
    ...
    public:
     ...
     public:
         ...
         DM(const Microsecond & d, const Microsecond & p = SAME, const Microsecond & c = UNKNOWN)
         : RT_Common(d, d, p, c) {}
     };
      ...
      public:
          ...
          EDF(const Microsecond & d, const Microsecond & p = SAME, const Microsecond & c = UNKNOWN); // Defined at Alarm
